...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/open-file.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushOpenInputFile.setIcon(icon1)
...
"}")
        ...
        self.pushAddWord.setIcon(icon3)
...
"}")
        ...
        self.pushRemoveWord.setIcon(icon5)
...
"}")
        ...
        self.pushLoadWordsFromFile.setIcon(icon1)
