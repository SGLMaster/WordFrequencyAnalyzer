...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupInflectOpts.setGeometry(QtCore.QRect(10, 60, 221, 51))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.groupInflectOpts.setFont(font)
        self.groupInflectOpts.setObjectName("groupInflectOpts")
        self.checkBox = QtWidgets.QCheckBox(self.groupInflectOpts)
        self.checkBox.setGeometry(QtCore.QRect(10, 20, 41, 17))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.checkBox.setFont(font)
        self.checkBox.setObjectName("checkBox")
        self.checkBox_2 = QtWidgets.QCheckBox(self.groupInflectOpts)
        self.checkBox_2.setGeometry(QtCore.QRect(60, 20, 51, 17))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.checkBox_2.setFont(font)
        self.checkBox_2.setObjectName("checkBox_2")
        self.checkBox_3 = QtWidgets.QCheckBox(self.groupInflectOpts)
        self.checkBox_3.setGeometry(QtCore.QRect(120, 20, 51, 17))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.checkBox_3.setFont(font)
        self.checkBox_3.setObjectName("checkBox_3")
        self.checkBox_4 = QtWidgets.QCheckBox(self.groupInflectOpts)
        self.checkBox_4.setGeometry(QtCore.QRect(180, 20, 41, 17))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.pushRun.setGeometry(QtCore.QRect(240, 80, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox.setText(_translate("MainWindow", "-ing"))
        self.checkBox_2.setText(_translate("MainWindow", "-s -es"))
        self.checkBox_3.setText(_translate("MainWindow", "-ed -d"))
